...
con = duckdb.connect('/Users/Manasi/Downloads/de_case_study/DE_project/dev.duckdb')

# Query the final_prices table
try:
    final_prices_df = con.execute("SELECT * FROM dev.main_final.final_prices").fetchdf()
    final_prices_df.to_csv('/Users/Manasi/Downloads/de_case_study/DE_project/results/final_prices.csv', index=False)
...
try:
    ...
    final_dq_check_df.to_csv('/Users/Manasi/Downloads/de_case_study/DE_project/results/final_dq_check.csv', index=False)
...
try:
    ...
    final_exchange_rate_df.to_csv('/Users/Manasi/Downloads/de_case_study/DE_project/results/interpolated_exchange_rates.csv', index=False)
...
#     metadata_coverage_df.to_csv('/Users/Manasi/Downloads/de_case_study/DE_project/results/metadata_coverage.csv', index=False)
